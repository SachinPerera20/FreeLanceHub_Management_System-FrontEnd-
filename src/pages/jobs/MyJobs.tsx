...
import { jobsService } from '../../services/jobs.service';  // add this import
...
import { Job } from '../../types';  // add this import
      ...
      <Layout>
        ...
        {isLoading ? (
            ...
            <div className="text-center py-12 bg-[#111827]/30 rounded-xl border border-gray-800 border-dashed">
              ...
              <Link to="/jobs/create"><Button>Post a Request</Button></Link>
            </div>
        )}
      </Layout>
  );
